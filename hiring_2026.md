...
* Strong research background in Quantum Optics/Quantum Information/Simulation of bosonic many body-systems as demonstrated by publications or dissertation work.
...
To be considered the applicant **must** hold an PhD degree or be in the process of obtaining one in the near term. Please submit your application by email (using the email nicolas.quesada@polymtl.ca) with the subject line: "Non-Gaussian Postdoc Applicant: [Name]", and include the following information:

1. A motivation letter (1 page max.) describing your research interests, background and experience. 

2. A curriculum vitae, indicating relevant publications.
